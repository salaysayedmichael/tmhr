        ...
        <div class="row">
            <div class="wizard-navigation">
                <ul class="nav nav-pills eval-nav text-center">
                    ...
                    <li data-nav-num="8" class="nav-eval width-13"><a class="eval-a" href="#general" data-toggle="tab">GENERAL</a></li>
                </ul>
            </div>
        </div>
...
-->
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class='col-md-6'>
                                        <label>OveAll Comments:</label>
                                        <textarea id="overall-comment" data-attr-id="<?php echo $evaluate['attribute_id'];?>" data-type="overall-comment" name="evaluator-overall-comments-<?php echo $evaluate['attribute_id'];?>" placeholder="Overall Comments Here..." class="form-control"></textarea>
                                    </div>

                                    <div class='col-md-6'>
                                        <label>OveAll Recommendations:</label>
                                        <textarea id="overall-recommendation" data-attr-id="<?php echo $evaluate['attribute_id'];?>" data-type="overall-recommendation" name="evaluator-overall-recommendations-<?php echo $evaluate['attribute_id'];?>" placeholder="Overall Recommendations Here..." class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row eval-page-container">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <label for="text4" class="control-label col-lg-2">Strengh</label>
                                    <div class="col-lg-10">
                                        <textarea id="general-strength" class="form-control"></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="text4" class="control-label col-lg-2">Weakness</label>
                                    <div class="col-lg-10">
                                        <textarea id="general-weakness" class="form-control"></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="text4" class="control-label col-lg-2">Plan for Improvement</label>
                                    <div class="col-lg-10">
                                        <textarea id="general-improvement" class="form-control"></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="text4" class="control-label col-lg-2">Training/Development</label>
                                    <div class="col-lg-10">
                                        <textarea id="general-development" class="form-control"></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="text4" class="control-label col-lg-2">Overall Recommendation</label>
                                    <div class="col-lg-10">
                                        <textarea id="general-overall-recommendation" class="form-control"></textarea>
                                    </div>
                                </div>
