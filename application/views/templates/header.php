        ...
        <div id="left">
            ...
            <ul id="menu" class="bg-blue dker">
                ...
                <li  class="<?php echo tabNavigation('dashboard', $page);?>">
                    <a id="dash-pointer" href="<?php echo base_url('dashboard');?>">
                ...
                <li class="<?php echo tabNavigation('evaluation', $page);?>">
                    ...
                    <ul class="collapse">
                        ...
                        <li>
                            <a href="<?php echo base_url('evaluation/settings');?>">
                        ...
                        <?php if(checkPermission('nte')) :?>
                        <li>
                            <a href="<?php echo base_url('evaluation/noticeExplain');?>">
                        ...
                        <?php if(checkPermission('nop')) :?>
                        <li>
                            <a href="<?php echo base_url('evaluation/noticePerformance');?>">
                ...
                <?php if(checkPermission('settings' , $page)) :?>
